...
const Navbar = () => {
  ...
  return (
 <div className='flex item-center justify-between text-sm py-4 mb-5 border-b boder-b-gray-400'>
        ...
        <div className='flex item-center gap-4'>
            {
                ...
                ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                    ...
                    <div className='absolute top-0 rifht-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
